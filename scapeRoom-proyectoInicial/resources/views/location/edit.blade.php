...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-danger">Detalles del Localidad</h6>
        </div>
        @if ($errors->any())
        ...
        <div class="card-body">
            ...
            <br>
            <a href="{{ route('location.list') }}" class="btn btn-dark float-right">&laquo; Volver a la lista de Localidades</a>
        </div>
    </div>
</div>
@stop
